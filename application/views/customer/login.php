                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo base_url('c_login/aksi_login'); ?>" method="post">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url() ?>c_data/register">
                                            Belum punya akun? Daftar Disini!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo base_url() ?>c_karyawan/">
                                            Anda karyawan? Klik Disini!</a>
                                    </div>
                                </div>
                            </div>
                        </div>

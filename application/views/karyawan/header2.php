...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>c_karyawan/home">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>c_karyawan/profile">
                    <i class="fas fa-fw fa-user"></i>
                    <span>Profile</span>
                </a>
                <a class="nav-link" href="<?php echo base_url() ?>c_karyawan/mobil">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Mobil</span>
                </a>
                <a class="nav-link" href="<?php echo base_url() ?>c_karyawan/logout" data-toggle="modal" data-target="#logoutModal">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a href="<?php echo base_url() ?>#" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <i class="fa fa-user"> <?php echo $this->session->userdata('user_u');?></i>
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo base_url() ?>c_karyawan/profile">

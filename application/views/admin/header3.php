...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url() ?>c_admin/mobil">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Mobil</span>
                </a>
                <a class="nav-link" href="<?php echo base_url() ?>c_admin/transaksi">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Transaksi</span>
                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?php echo base_url() ?>c_admin/detail">
